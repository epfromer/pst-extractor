...
export class PSTUtil {
  ...
  public static filetimeToDate(hi: long, low: long): Date {
    ...
    const ms_since_16010101: long = filetime.divide(1000 * 10)
    const epoch_diff: long = long.fromValue('11644473600000')
    const ms_since_19700101: long = ms_since_16010101.subtract(epoch_diff)
